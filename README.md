...
A script which is run separately on an admin computer [getCitationsAndLastUpdate.m](_data/getCitationsAndLastUpdate) every few months will allow automatic updating of the number of citations and the date the software was last updated (using GitHub / Bitbucket APIs to retrieve last commit date).
